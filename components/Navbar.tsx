...
const toogleSidebar =()=>{
  ...
  return (
    <nav className="w-100vw h-14 bg-black flex justify-between items-center border border-gray-900 px-7">
      <div className="flex gap-4 items-center">
        <FaBars className="cursor-pointer" onClick={toogleSidebar} />
        <Link href={"/"}>
          <div className="text-xl">Vrixaalabs LMS</div>
        </Link>
      </div>
      ...
      {
        sidebar && <div className="min-h-screen bg-black w-1/4 fixed top-0 left-0 transition duration-1000">
